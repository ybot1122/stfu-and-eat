---
title: "Everything new in STFU and EAT"
...
[Pagefind](https://pagefind.app) is a search library for static websites. This site uses [Sergey Shishkin's](https://github.com/shishkin) [astro-pagefind](https://github.com/shishkin/astro-pagefind) integration. This integration simplifies development and does not require any changes to the default build script.
